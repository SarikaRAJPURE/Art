...
import { CalendarToday, MailOutline, PermIdentity, PhoneAndroid, LocationSearching, Publish } from '@mui/icons-material';
const User = () => {
    return (
        <div className="user">
                    ...
                    <form className="userUpdateForm">
                        ...
                        <div className="userUpdateRight">
                            <div className="userUpdateUpload">
                                <img src="../profilepic.jpg" className="userUpdateImage" alt="" />
                                <label htmlFor="file">
